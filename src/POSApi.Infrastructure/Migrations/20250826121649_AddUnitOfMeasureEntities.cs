...
{
    /// <inheritdoc />
    public partial class AddUnitOfMeasureEntities : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversionFactorToBase = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, defaultValue: 1.0m),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UnitOfMeasure_UnitType_UnitTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Promotion_User_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VendorProductCode = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    LastPurchaseCost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    LastPurchaseDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PricePerBaseUnit = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    CostPerBaseUnit = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Product_Vendor_PrimaryVendorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Return_Order_OriginalOrderId",
                        column: x => x.OriginalOrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Return_User_ProcessedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_PromotionUsage_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseQuantity = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: false, defaultValue: 1.0m),
                    PackagingUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    PackagingQuantity = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    DisplayName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    Weight = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    WeightUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Volume = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    VolumeUnitId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductUnit_UnitOfMeasure_BaseUnitId",
                        column: x => x.BaseUnitId,
                        principalTable: "UnitOfMeasure",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductUnit_UnitOfMeasure_PackagingUnitId",
                        column: x => x.PackagingUnitId,
                        principalTable: "UnitOfMeasure",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductUnit_UnitOfMeasure_VolumeUnitId",
                        column: x => x.VolumeUnitId,
                        principalTable: "UnitOfMeasure",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductUnit_UnitOfMeasure_WeightUnitId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_PrimaryVendorId",
                table: "Product",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUnit_BaseUnitId",
                table: "ProductUnit",
                column: "BaseUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductUnit_PackagingUnitId",
                table: "ProductUnit",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUnit_VolumeUnitId",
                table: "ProductUnit",
                column: "VolumeUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductUnit_WeightUnitId",
                table: "ProductUnit",
                column: "WeightUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_Promotion_CouponCode",
                table: "Promotion",
                column: "CouponCode",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotion_CreatedByUserId",
                table: "Promotion",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Promotion_EndDate",
                table: "Promotion",
                column: "EndDate");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Promotion_StartDate",
                table: "Promotion",
                column: "StartDate");

            migrationBuilder.CreateIndex(
                name: "IX_Promotion_StartDate_EndDate_IsActive",
                table: "Promotion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionCategory_PromotionId_CategoryId",
                table: "PromotionCategory",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionProduct_PromotionId_ProductId",
                table: "PromotionProduct",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PromotionUsage_OrderId",
                table: "PromotionUsage",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Return_OriginalOrderId",
                table: "Return",
                column: "OriginalOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_Return_ProcessedByUserId",
                table: "Return",
                column: "ProcessedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Return_ReturnDate",
                table: "Return",
                column: "ReturnDate");

            migrationBuilder.CreateIndex(
                name: "IX_Return_ReturnNumber",
                table: "Return",
                column: "ReturnNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Return_Status",
                table: "Return",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitOfMeasure_IsBaseUnit",
                table: "UnitOfMeasure",
                column: "IsBaseUnit");

            migrationBuilder.CreateIndex(
                name: "IX_UnitOfMeasure_UnitTypeId_SortOrder",
                table: "UnitOfMeasure",
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Returns_Orders_OriginalOrderId",
                        column: x => x.OriginalOrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Returns_OriginalOrderId",
                table: "Returns",
                column: "OriginalOrderId");
