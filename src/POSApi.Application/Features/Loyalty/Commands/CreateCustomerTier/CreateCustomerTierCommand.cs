...
public class CreateCustomerTierCommand : ICommand<Guid>
{
...
public class CreateCustomerTierCommandValidator : AbstractValidator<CreateCustomerTierCommand>
{
    public CreateCustomerTierCommandValidator()
    {
        RuleFor(x => x.Name)
